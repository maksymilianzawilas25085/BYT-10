...
public class Money implements Comparable {
	...
	public String toString() {
		return String.format("%d %s", this.amount/100, this.currency.getName());
	}
	...
	public Money add(Money other) {
		int otherinthiscurrency = currency.valueInThisCurrency(other.amount, other.currency);
		return new Money(amount+otherinthiscurrency, currency);
	}
	...
	public int compareTo(Object other) {
		...
		return this.universalValue() - otherMoney.universalValue();
	}
}